...
func (c *videoClient) CreateComment(ctx context.Context, in *CreateCommentRequest, opts ...grpc.CallOption) (*CreateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/video.Video/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/video.Video/DeleteComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) GetCommentById(ctx context.Context, in *GetCommentByIdRequest, opts ...grpc.CallOption) (*GetCommentByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/video.Video/GetCommentById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) GetCountById(ctx context.Context, in *GetCountByIdRequest, opts ...grpc.CallOption) (*GetCountByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/video.Video/GetCountById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Video_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.Video/CreateComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Video_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.Video/DeleteComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Video_GetCommentById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.Video/GetCommentById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Video_GetCountById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/video.Video/GetCountById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
