...
var file_user_proto_rawDesc = []byte{
	...
	0x22, 0xea, 0x01, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17, 0x0a,
	0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x69, 0x6e, 0x67, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x66, 0x6f, 0x6c,
	...
	0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x12,
...
var file_user_proto_depIdxs = []int32{
	...
	0,  // 2: user.User.Ping:input_type -> user.PingRequest
	2,  // 3: user.User.Create:input_type -> user.CreateRequest
	4,  // 4: user.User.QueryById:input_type -> user.QueryByIdRequest
	5,  // 5: user.User.QueryByName:input_type -> user.QueryByNameRequest
	8,  // 6: user.User.Follow:input_type -> user.FollowRequest
	9,  // 7: user.User.UnFollow:input_type -> user.UnFollowRequest
	11, // 8: user.User.GetFollowerList:input_type -> user.GetFollowerListRequest
	13, // 9: user.User.GetFollowingList:input_type -> user.GetFollowingListRequest
	15, // 10: user.User.IsFollow:input_type -> user.IsFollowRequest
	1,  // 11: user.User.Ping:output_type -> user.PingResponse
	3,  // 12: user.User.Create:output_type -> user.CreateResponse
	6,  // 13: user.User.QueryById:output_type -> user.QueryResponse
	6,  // 14: user.User.QueryByName:output_type -> user.QueryResponse
	7,  // 15: user.User.Follow:output_type -> user.Empty
	7,  // 16: user.User.UnFollow:output_type -> user.Empty
	12, // 17: user.User.GetFollowerList:output_type -> user.GetFollowerListResponse
	14, // 18: user.User.GetFollowingList:output_type -> user.GetFollowingListResponse
	16, // 19: user.User.IsFollow:output_type -> user.IsFollowResponse
